...
This can then be used in a [az copy command](https://learn.microsoft.com/en-us/azure/storage/common/storage-use-azcopy-blobs-upload) to authenticate the user and uploade the file to a storage container.
...
Run Shell interactively and be prompted to input the storag account name and container name.
