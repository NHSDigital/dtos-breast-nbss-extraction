...
| --- | --- | --- |
| [main.bicep](bootstrap/main.bicep) | Coordinates bootstrap modules and creates the infrastructure resource group | storageAccountId, storagePrivateDNSZoneId, storagePrivateEndpointId, infraResourceGroupId |
| [terraformStorage.bicep](bootstrap/terraformStorage.bicep) | Terraform state storage and Entra group role assignment | storageAccountID |
| [dns.bicep](bootstrap/dns.bicep) | Existing private DNS zone lookup | privateDNSZoneID |
| [privateEndpoint.bicep](bootstrap/privateEndpoint.bicep) | Private endpoint and DNS zone-group wiring | privateEndpointID |
